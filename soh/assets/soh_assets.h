...
#define dgTitleSpeedrunSubtitleTex "__OTR__objects/object_mag/gTitleBossRushSubtitleTex"
static const ALIGN_ASSET(2) char gTitleSpeedrunSubtitleTex[] = dgTitleBossRushSubtitleTex;
