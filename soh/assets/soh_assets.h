...
#define dgTitleSpeedrunSubtitleTex "__OTR__objects/object_mag/gTitleSpeedrunSubtitleTex"
static const ALIGN_ASSET(2) char gTitleSpeedrunSubtitleTex[] = dgTitleSpeedrunSubtitleTex;
